 ...
 */
package id.go.tangerangkota.nsc.nfc;
...
public class ActivityNFC extends Activity {
    ...
    private String dumpTagData(Tag tag) {
        ...
        StringBuilder cekstring = new StringBuilder();
        for (byte b : id) {
            cekstring.append(String.format("%02X", b));
        };
        ...
        Log.d(TAG, "cek isi tag nfc : "+sb.toString());
    ...
    void buildTagViews(NdefMessage[] msgs) {
        ...
        Log.d(TAG, "cek panjang record: "+records.size());
        ...
        for (int i = 0; i < size; i++) {
            ...
            Log.d(TAG, "cek isi file: "+records.get(i));
